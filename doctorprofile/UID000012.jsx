      ...
      try {
        ...
        if (foundDoctor) {
          ...
          const formattedDoctor = {
            ...foundDoctor,
            ImageUrl: foundDoctor.ImageUrl || "https://randomuser.me/api/portraits/women/45.jpg",
            ExperienceYears: foundDoctor.ExperienceYears || 8,
            LicenseNumber: foundDoctor.LicenseNumber || "BS-2024-0012",
            Email: foundDoctor.Email || "doctor@hospital.com",
            Phone: foundDoctor.Phone || "090-000-0000",
            Education: "Đại học Y Dược TP.HCM - Chuyên ngành Nội khoa",
            Certifications: [
            ...
            Với ${foundDoctor.ExperienceYears || 8} năm kinh nghiệm, bác sĩ đã tham gia điều trị cho nhiều bệnh nhân và có nhiều đóng góp quan trọng trong việc chăm sóc sức khỏe cộng đồng. 
            Bác sĩ cũng là thành viên của nhiều hiệp hội y khoa và thường xuyên tham gia các hội nghị chuyên môn quốc tế.`,
            Specializations: [
            ...
            Awards: [
              ...
              "Huy chương vàng về chăm sóc bệnh nhân"
            ],
            Publications: [
              "Nghiên cứu về hiệu quả điều trị bệnh nhân HIV/AIDS",
              "Hướng dẫn điều trị cho bác sĩ đa khoa",
              "Tài liệu tư vấn dinh dưỡng cho bệnh nhân",
              "Phương pháp chăm sóc bệnh nhân mãn tính"
            ]
          };
